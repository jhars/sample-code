# ENTIRE APP CODE FOUND HERE:
# https://github.com/rolaandoes/nexu/blob/master/app/controllers/matches_controller.rb
...
def connection
    #Probably should move this into SERVICE, not CRUD
